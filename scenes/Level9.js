...
class Level9 extends Phaser.Scene {
    ...
    create() {
        ...
        var appleAngle = Phaser.Math.Between(270, 340);
        var appleAngle2 = Phaser.Math.Between(160, 260);
        var orangeAngle = Phaser.Math.Between(90, 150);
    ...
    onEvent() {
        localStorage.setItem('Completed Level', 9);
