...
class Level1 extends Phaser.Scene {
    ...
    create() {
        ...
        //score 
        this.scroe = 0;
        scoreText = this.add.text(game.config.width / 13, game.config.height / 20, 'SCORE:0', { fontSize: '30px', fill: '#FFF' });
    ...
    throwKnife() {
        ...
        if (this.canThrow) {
            ...
            //reduce and destroy hited knifes           
            // this.knife1+''+this.hitknifecount.destroy();
