...
class Level10 extends Phaser.Scene {
    ...
    create() {
        ...
        var appleAngle = Phaser.Math.Between(180, 230);
        var appleAngle2 = Phaser.Math.Between(240, 300);
        var orangeAngle = Phaser.Math.Between(310, 350);
        var rockAngle = Phaser.Math.Between(0, 70);
        var rockAngle2 = Phaser.Math.Between(100, 160);
    ...
    onEvent() {
        if (localStorage.getItem('Completed Level') <= 10) {
            localStorage.setItem('Completed Level', 10);
        }
